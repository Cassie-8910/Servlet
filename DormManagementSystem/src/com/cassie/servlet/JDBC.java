...
//    static final String DB_URL = "jdbc:mysql://localhost:3306/dorm_info?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=GMT%2B8";
...
//        String sql = "delete from detail_info where stuNum='" + stuNum + "'";
//        Statement statement = connection.createStatement();
...
//        String sql = "select * from detail_info where stuNum='" + stuNum + "'";
//        Statement statement = connection.createStatement();
...
//        stuNums.forEach(k -> {
//            try {
//                String sql = "select * from  detail_info where stuNums='" + k + "'";
